...
import com.example.android.sunshine.gson.Weather;
...
public class TestDb extends AndroidTestCase {
    ...
    void deleteTheDatabase() {
        try {
            Log.i(LOG_TAG, "M Context -> " + mContext);
            mContext.deleteDatabase(WeatherDbHelper.DATABASE_NAME);
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(LOG_TAG, "Delete the Database ", e);
        }
    }
    ...
    */
    public void testLocationTable() {
        ...
        ContentValues northpoleContentValues = new TestUtilities().createNorthPoleLocationValues();
